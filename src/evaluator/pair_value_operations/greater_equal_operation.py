...
class GreaterEqualOperation(PairValuesOperation):
    ...
    def calculate(self, first: str, second: str) -> str:
        try:
            ...
            raise EvaluationError(f"GreaterEqualFailed") from e
    ...
    def documentation(self) -> str:
        ...
        @returns: 1: first parameter greater or equal to the second
                  0: otherwise  
